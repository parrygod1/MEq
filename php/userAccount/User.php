...
class User {
    ...
    public function __construct() {
        ...
        $this->google_client->setRedirectUri(DomainPath::DOMAINPROTOCOL . "://" . DomainPath::MAINDOMAIN . '/php/userAccount/login.php');
        ...
        $this->facebook_login_url = $this->facebook_helper->getLoginUrl(DomainPath::DOMAINPROTOCOL . "://" . DomainPath::MAINDOMAIN . '/php/userAccount/login.php', $this->facebook_permissions);
    }
